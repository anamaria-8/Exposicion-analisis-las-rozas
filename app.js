 <!-- INTEGRACIÓN FIREBASE REALTIME DATABASE -->
    <script type="module">
        ...
        // Datos iniciales de resguardo por si la base de datos está vacía
        ...
        // Referencias a nodos en Firebase
        const exposRef = ref(db, 'exposiciones');
        const infoRef = ref(db, 'informacion');

        // Escucha en tiempo real de exposiciones
        ...
        // Escucha en tiempo real de la sección de información
        ...
        // Funciones del sistema asignadas al ámbito global (window)
        ...
        window.guardarInformacionRedactada = function() {
            ...
            set(infoRef, nuevoTexto).then(() => {
                alert("Pestaña Información actualizada en la nube.");
            }).catch((error) => {
